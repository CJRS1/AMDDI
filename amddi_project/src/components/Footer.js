...
export default function Footer() {
    return (
        <footer classNameName='footer_container'>
            <div className="footer-description">
                <div className="footer-description-amddi">
                    <h5><strong>Nosotros</strong></h5>
                    <div className="footer-content">
                        <h5>
                            <strong>AMDDI</strong> es una empresa blablalba
                        </h5>
                    </div>
                    <h5><strong>Síguenos en nuestras redes</strong></h5>
                    <div className="footer-socialnetwork">
                        <a className="redes" href="https://translate.google.com/?sl=en&tl=es&text=liying&op=translate" rel="noreferrer"
                            target="_blank">
                            <img src={require('../images/Facebook.png')} alt='facebook' height={'50px'} />
                        </a>
                        <a className="redes" href="https://translate.google.com/?sl=en&tl=es&text=liying&op=translate"
                            rel="noreferrer" target="_blank">
                            <img src={require('../images/Instagram.png')} alt='instagram' height={'50px'} />
                        </a>
                        <a className="redes" href="https://translate.google.com/?sl=en&tl=es&text=liying&op=translate"
                            rel="noreferrer" target="_blank">
                            <img src={require('../images/Linkedin.webp')} alt='linkedin' height={'50px'} />
                        </a>
                        <a className="redes" href="https://translate.google.com/?sl=en&tl=es&text=liying&op=translate"
                            rel="noreferrer" target="_blank">
                            <img src={require('../images/Tiktok.png')} alt='tiktok' height={'50px'} />
                        </a>
                    </div>
                </div>
                <div className="footer-description-nuestrosservicios">
                    <h5><strong>Nuestros servicios</strong></h5>
                    <ul className="container-list">
                        <li>
                            <a className="servicios" href="/nuestrosservicios/#outsourcing">
                                <h5>Redacción de Tesis de Pregrado</h5>
                            </a>
                        </li>
                        <li>
                            <a className="servicios" href="/nuestrosservicios/#trademarketing">
                                <h5>Redacción de Tesis de Pregrado</h5>
                            </a>
                        </li>
                        <li>
                            <a className="servicios" href="/nuestrosservicios/#selecciondepersonal">
                                <h5>Levantamiento de Observaciones Pregrado</h5>
                            </a>
                        </li>
                        <li>
                            <a className="servicios" href="/nuestrosservicios/#headhunting">
                                <h5>Levantamiento de Observaciones Maestría</h5>
                            </a>
                        </li>
                        <li>
                            <a className="servicios" href="/nuestrosservicios/#capacitaciones">
                                <h5>Parafraseo</h5>
                            </a>
                        </li>
                        <li>
                            <a className="servicios" href="/nuestrosservicios/#seguridadysalud">
                                <h5>Trabajo de Suficiencia Profesional</h5>
                            </a>
                        </li>
                        <li>
                            <a className="servicios" href="/nuestrosservicios/#produccion">
                                <h5>Artículo Científico</h5>
                            </a>
                        </li>
                        <li>
                            <a className="servicios" href="/nuestrosservicios/#lanzamientos">
                ...
                <div className="footer-description-ubicanos">
                    <h5><strong>Ubícanos</strong></h5>
                    <div className="card-icloc">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="blue" className="bi bi-geo-alt"
                            viewBox="0 0 16 16">
                            <path
                ...
                <div className="footer-description-llamanos">
                    ...
                    <div className="container-ictel">
                        <div className="card-ictel">
                            ...
                            <h5>Celulares: 937 965 909 - 960 797 793</h5>
                        </div>
            ...
            <p className="footer-text">
                Copyright © Capital Human Group. All rights reserved.
            </p>
