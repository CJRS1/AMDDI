                ...
                <div className="servicios_carreras">
                    <div className="carrera_grupo">
                        <div class="biologicas">
                            ...
                            <ul> <li>Agronomía</li> <li>Biología</li> <li>Zootecnia</li> <li>Farmacia y Bioquímica</li> <li>Microbiología y Parasitología</li> <li>Veterinaria</li> </ul>
                        </div>
                        <div class="basicas">
                            <h3><strong>Ciencias Básicas</strong></h3> <ul> <li>Estadística</li> <li>Matemática</li> <li>Química</li> </ul> </div>
                    </div>

                    <div class="ingenieria">
                        <h3><strong>Ingenierías y Arquitectura</strong></h3> <ul> <li>Ing. Industrial</li> <li>Ing. Ambiental</li> <li>Ing. Mecatrónica</li> <li>Ing. de Seguridad</li> <li>Ing. Agrícola</li> <li>Ing. de Minas</li> <li>Ing. Metalúrgica</li> <li>Ing. Civil</li> <li>Ing. Electrónica</li> <li>Ing. Mecánica</li> <li>Ing. Empresarial</li> <li>Ing. de Alimentos</li> <li>Ing. Geofísica</li> <li>Arquitectura</li> <li>Ing. de Sistemas</li> <li>Ing. Eléctrica</li> <li>Ing. Agroindustrial</li> <li>Ing. Económica</li> <li>Ing. Química</li> <li>Ing. Geológica</li> </ul> </div>
                    <div class="sociales">
                        <h3><strong>Ciencias Sociales</strong></h3> <ul> <li>Educación Inicial</li> <li>Traducción e interpretación</li> <li>Antropología</li> <li>Marketing</li> <li>Lengua y Literatura</li> <li>Educación Secundaria</li> <li>Educación física</li> <li>Derecho</li> <li>Trabajo Social</li> <li>Sociología</li> <li>Educación Primaria</li> <li>Inglés</li> <li>Ciencias Políticas y Gobernabilidad</li> <li>Ciencias de la comunicación</li> <li>Arqueología</li> </ul> </div>
                    <div className="carrera_grupo">
                        <div class="empresariales"> <h3><strong>Ciencias Empresariales</strong></h3> <ul> <li>Gestión y Alta dirección</li> <li>MBA</li> <li>Economía</li> <li>Administración</li> <li>Turismo</li> <li>Contabilidad</li> <li>Neg. Internacionales</li> </ul>
                        </div>
                        <div class="salud">
                            <h3><strong>Ciencias de la Salud</strong></h3> <ul> <li>Psicología</li> <li>Enfermería</li> <li>Medicina</li> <li>Obstetricia</li> <li>Tecnología Médica</li> <li>Estomatología</li> <li>Nutrición</li> </ul> </div>
                    </div>
                </div>
            </div>
