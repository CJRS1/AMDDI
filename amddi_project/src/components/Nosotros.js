                ...
                <div className="quienessomos-container">
                    <div className="quienessomos-descripcion">
                        <div className="img-titulo">
                            <img className="img-logo-vimi" src={require('../images/Logo_soloblanco.png')} alt='Logo_AMDDI' height={'40px'} />
                            <h2>¿Quiénes somos?</h2>
                        </div>
                    ...
                    <div className="quienessomos-img">
                        <img className="img-logo" src={require('../images/Nosotros/quienes.jpeg')} alt='quienessomos' height={'400px'} width={'400px'} />
                    </div>
                </div>
            </div>
